...
// 🔐 Replace with your own live Moniepoint API URL and key
...
Meteor.methods({
  async "wallet.transfer"(userId, amount, currency, accountNumber) {
    try {
      ...
      // 🔁 Conversion (1 SKD = $2000)
      let conversionRate = 1;
      if (currency === "USD") conversionRate = 2000;
      if (currency === "NGN") conversionRate = 2000 * 1600;

      const convertedAmount = amount * conversionRate;

      // 🔗 Send transfer request to Moniepoint

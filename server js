...
if (!process.env.PAYSTACK_SECRET_KEY) {
  console.error("❌ PAYSTACK_SECRET_KEY missing in Render ENV");
  process.exit(1);
}
...
// ---------- CONFIG (FROM ENV) ----------
const SKD_TO_NGN = Number(process.env.SKD_TO_NGN); // e.g 3000
...
// ---------- START SERVER ----------
app.listen(PORT, () => {
  console.log("🚀 Mine backend running on Render");
});

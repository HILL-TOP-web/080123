...
// ---------- CONFIG ----------
const SKD_TO_NGN = 3000000; // 1 SKD = $2,000 ≈ ₦3,000,000
const SKD_TO_USD = 2000;    // 1 SKD = $2,000
const MIN_WITHDRAW_SKD = 500; // minimum withdrawal

// ---------- ROUTES ----------

// ⛏️ MINE (20 SKD PER SECOND – TIME BASED)
app.post("/mine", (req, res) => {
  ...
  const minedSKD = secondsPassed * 20; // ✅ 20 SKD per second

  wallet.balance += minedSKD;

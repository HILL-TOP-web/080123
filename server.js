...
import withdrawRoute from "./routes/withdrawRoute.js"; // Paystack-ready withdrawal route
...
const requiredEnv = ["PAYMENT_SECRET_KEY", "MONGO_URI"];
...
app.locals = {
  ...
  SKD_TO_USD,
  MIN_WITHDRAW_SKD,
  PAYMENT_SECRET_KEY: process.env.PAYMENT_SECRET_KEY // accessed directly from Render or OS
};

// ---------- ROUTES ----------
app.use("/wallet", walletRoute);       // Mining, convert, wallet status
app.use("/withdraw", withdrawRoute);   // Real-money withdrawals (Paystack-ready)
